                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.majors.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" class="border px-3 py-2 w-full" rows="3">{{ old('description') }}</textarea>
                        </div>
                        <div class="flex justify-end gap-2">
                            <a href="{{ route('admin.majors.index') }}" class="px-4 py-2 border rounded">Batal</a>
